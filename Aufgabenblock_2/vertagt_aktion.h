...
{
	// Oberklasse VAktion
//------VAktion dient als die abstrakte Oberklasse zu den 3 Operationen(speichert nur die eingegebene Liste)-----//
	template <class T>
	class VAktion
	{
	protected:
	...
	public:
	   // Benötigt man einen Standardkonstruktor? Nein. eine Liste muss beim Konstruktor immer als der parameter eingegeben werden
